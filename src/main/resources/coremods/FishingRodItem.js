                ...
                var toInject = new InsnList();
                {
                    ...
                    methodNode.localVariables.add(
                        new LocalVariableNode(
                            'preEvent',
                            'Lorg/auioc/mcmod/harmonicench/server/event/impl/FishingRodCastEvent$Pre;',
                            null,
                            fn_start,
                            fn_end,
                            7
                    ...
                    toInject.add(
                        new MethodInsnNode(
                            ...
                            'preFishingRodCast',
                            '(Lnet/minecraft/world/entity/player/Player;Lnet/minecraft/world/level/Level;Lnet/minecraft/world/item/ItemStack;II)Lorg/auioc/mcmod/harmonicench/server/event/impl/FishingRodCastEvent$Pre;',
                            false
                        )
                    );
                    ...
                    toInject.add(
                        new MethodInsnNode(
                            ...
                            'org/auioc/mcmod/harmonicench/server/event/impl/FishingRodCastEvent$Pre',
                            'getSpeedBonus',
                            '()I',
                            false
                        )
...
+   7       preEvent     Lorg/auioc/mcmod/harmonicench/server/event/impl/FishingRodCastEvent$Pre;
*/
...
+               FishingRodCastEvent.Pre preEvent = org.auioc.mcmod.harmonicench.server.event.HEServerEventFactory.preFishingRodCast(p_41291_, p_41290_, itemstack, k, j);
...
+       ILOAD 5
+       ILOAD 6
+       INVOKESTATIC org/auioc/mcmod/harmonicench/server/event/HEServerEventFactory.preFishingRodCast (Lnet/minecraft/world/entity/player/Player;Lnet/minecraft/world/level/Level;Lnet/minecraft/world/item/ItemStack;II)Lorg/auioc/mcmod/harmonicench/server/event/impl/FishingRodCastEvent$Pre;
+       ASTORE 7
+       ALOAD 7
+       INVOKEVIRTUAL org/auioc/mcmod/harmonicench/server/event/impl/FishingRodCastEvent$Pre.getSpeedBonus ()I
+       ISTORE 5
+       ALOAD 7
+       INVOKEVIRTUAL org/auioc/mcmod/harmonicench/server/event/impl/FishingRodCastEvent$Pre.getLuckBonus ()I
+       ISTORE 6
+   L15
        ALOAD 1
