...
+           p_41630_ = org.auioc.mcmod.harmonicench.server.event.HEServerEventFactory.onItemHurt(this, p_41630_, p_41631_, p_41632_);
            if (p_41630_ > 0) {
                //_ ...
            }
            //_ ...
...
+       ALOAD 2
+       ALOAD 3
+       INVOKESTATIC org/auioc/mcmod/harmonicench/server/event/HEServerEventFactory.onItemHurt (Lnet/minecraft/world/item/ItemStack;ILjava/util/Random;Lnet/minecraft/server/level/ServerPlayer;)I
+       ISTORE 1
        ILOAD 1
        IFLE L3
    L4
